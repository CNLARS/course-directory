  ...
  render() {
    return (
      <div className="main-content home">
        ...
        <Link to="teachers/JavaScript/Tommy">Tommy Oliver</Link><br /><br />
        <Link to="teachers/HTML/Kimberly">Kimberly Hart</Link><br /><br />
        <Link to="teachers/CSS/Zach">Zach Taylor</Link><br /><br />
        <Link to="teachers/JavaScript/Billy">Billy Cranston</Link><br /><br />
        <Link to="teachers/CSS/Trini">Trini Kwan</Link><br /><br />
        <Link to="teachers/HTML/Jason">Jason Lee Scott</Link><br /><br />
        
        <h4>Search for Instructor:</h4>
